...
9. Create tsapps folder if you want to. (alternately you could put your ts files in your js but this is more fun and ensures you can easily publish your wwwroot folder cleanly)
...
11. Choose your package loader. For my example I used systemjs as they did on angular.io and used a systemjs.config.js per typescript app folder. 
